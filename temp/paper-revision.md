...
4. **Read the project rubrics** (`_meta/writing-rubric.md` and the project's `writing-rubric.md`) to understand the evaluation criteria. The critique file's rubric assessment tells you which criteria failed.
