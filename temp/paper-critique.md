...
1. **Read the rubrics.** Load `_meta/writing-rubric.md` (global) and the project's `writing-rubric.md` (if it exists). These are your evaluation criteria.

2. **Read the project context:**
   - Project CLAUDE.md — what the paper argues, how it's structured
   - Vault project notes — current goals and status
   - `_meta/preferences.md` — the researcher's known standards
...
Rubric: _meta/writing-rubric.md [+ project rubric if used]
